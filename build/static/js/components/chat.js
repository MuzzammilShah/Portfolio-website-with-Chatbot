...
function setUserResponse(message) {
  const user_response = `<img class="userAvatar" src='./static/img/usr-icon.png'><p class="userMsg">${message} </p><div class="clearfix"></div>`;
...
function getBotResponse(text) {
  botResponse = `<img class="botAvatar" src="./static/img/profile.png"/><span class="botMsg">${text}</span><div class="clearfix"></div>`;
  return botResponse;
}
        ...
        if (Object.hasOwnProperty.call(response[i], "text")) {
          if (response[i].text != null) {
            ...
            if (
              ...
              if (!botResponse) {
                botResponse = `<img class="botAvatar" src="./static/img/profile.png"/><p class="botMsg">${response[i].text}</p><div class="clearfix"></div>`;
              }
            }
